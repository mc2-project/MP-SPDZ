...
*   Party 0: ./bench_dspdz_triple_flat.x -N 4 -l 170 -h x.x.x.x -p 0
*   Party 1: ./bench_dspdz_triple_flat.x -N 4 -l 170 -h x.x.x.x -p 1
*   Party 2: ./bench_dspdz_triple_flat.x -N 4 -l 170 -h x.x.x.x -p 2
*   Party 3: ./bench_dspdz_triple_flat.x -N 4 -l 170 -h x.x.x.x -p 3
